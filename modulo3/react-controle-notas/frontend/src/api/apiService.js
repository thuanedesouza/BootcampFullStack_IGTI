...
//garantir que novas notas respeitem o valor min e max
...
async  function getAllGrades()  {
    ...
    //Set() é uma estrutura do tipo conjunto, elementos não se repetem
    let allStudents = new Set();
    grades.forEach(grade => allStudents.add(grade.student));
    // set só para fazer a verificação, quero array
   ...
   let maxId = -1;
    ...
    allCombinations.forEach(({student, subject, type}) => {
        ...
        //nao estando na api a gente indica que foi excluido logicamnte,
        // o objetivo é lembrar ao user de atualizar a nota excluida
